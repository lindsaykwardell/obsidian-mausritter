// Adventure site generation tables — all content from the Mausritter SRD adventure site toolbox

// Summary construction phrases (with articles for natural sentences)
...
export const ruinActions: string[] = [
	"ruined by",
	"in ruins due to",
	"desecrated by",
	"left crumbling by",
...
export const ruinations: string[] = [
	"flooding",
	"a magical mishap",
	"age and rot",
	"human destruction",
...
export const inhabitants: string[] = [
...
export const inhabitantActions: string[] = [
	"search for",
	"protect",
	"guard",
	"hunt for",
...
export const inhabitantGoals: string[] = [
...
export const secretHiddens: string[] = [
	"Deep within",
	"Hidden away",
	"Unknown to all",
	"Beneath",
...
export const emptyRoomDescriptions: string[] = [
...
export const obstacleDescriptions: string[] = [
	...
	"Device that creates a high-pitched scream. Each Turn spent here or in adjacent rooms gives Frightened Condition.",
...
export const trapDescriptions: string[] = [
...
export const puzzleDescriptions: string[] = [
...
export const lairDescriptions: string[] = [
...
// Creature thresholds per room type: creature present if d6 <= threshold
export const creatureThresholds: Record<string, number> = {
	Empty: 3,
	Obstacle: 2,
	Trap: 1,
	Puzzle: 1,
...
// Treasure thresholds per room type: treasure present if d6 <= threshold
export const treasureThresholds: Record<string, number> = {
	Empty: 1,
	Obstacle: 1,
	Trap: 2,
	Puzzle: 5,
...
// Generic evocative words for site names (not from SRD)
export const siteNameAdjectives: string[] = [
	"Whispering",
	"Forgotten",
	"Hollow",
	"Crooked",
...
export const siteNameNouns: string[] = [
	"Burrow",
	"Warren",
	"Hollow",
	"Den",
